...
(root, no password), edit `perioda/api/db.php`:
...
├── dashboard.html         Main user dashboard (SPA)
├── dashboard.js           User logic, DOM manipulation & API requests
├── admin-dashboard.html   Main admin dashboard (SPA)
├── admin-dashboard.js     Admin logic & API requests
├── api/                   Backend REST API endpoints (PHP)
│   ├── db.php             PDO Database connection
│   ├── auth.php           Session verification helpers
│   ├── register.php
│   ├── login.php
│   └── ...                Other CRUD endpoints
├── assets/                Images and generic assets
