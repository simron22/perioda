...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $stmt = $pdo->prepare("SELECT period_id AS id, start_date, end_date, estimated_ovulation_date, sexual_activity_dates, notes, created_at FROM period_records WHERE user_id = ? ORDER BY start_date DESC");
