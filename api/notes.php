...
$user_id = $_SESSION['user_id'];
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET') {
        ...
        $stmt = $pdo->prepare("SELECT note_id AS id, title, note AS content, created_at FROM notes WHERE user_id = ? ORDER BY created_at DESC");
        ...
        $stmt = $pdo->prepare("INSERT INTO notes (user_id, title, note, note_date) VALUES (?, ?, ?, CURDATE())");
        ...
        $stmt = $pdo->prepare("UPDATE notes SET title = ?, note = ? WHERE note_id = ? AND user_id = ?");
